...
def parse_args():
    ...
    parser.add_argument("--checkpoint-path", default="checkpoints/resnet18_tinyimagenet.pkl")
    parser.add_argument("--save-every", type=int, default=5)
    parser.add_argument("--resume-from", default=None)
    parser.add_argument("--log-dir", default="logdir/resnet18_tinyimagenet")
...
def main():
    ...
    model = ResNet18(in_channels=3, num_classes=200, device=device).to(device)
